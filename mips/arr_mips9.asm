.data
A: .word 3, 1, 3, 3,3, 3, 2, 1, 4, 4
msg: .asciiz "Phan tu xuat hien it nhat: "
msg1: .asciiz ", "
...
count:
    ...
    li $s0, 9       # l?u s? l?n xu?t hi?n it nh?t
    li $s1, -1    # l?u ph?n t? có s? l?n xu?t hi?n it nh?t
    li $s2, 0       # i
    li $s3, 4       # j
